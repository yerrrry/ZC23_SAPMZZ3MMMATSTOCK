		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Material Stock View",
									"targetURL": "#zc23matstock-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc23matstock-display": {
								"semanticObject": "zc23matstock",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc23matstock",
									"url": sap.ui.require.toUrl("zc23matstock")
								}
							}
						}
					}
