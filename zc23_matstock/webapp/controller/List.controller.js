sap.ui.define([
    ...
    "sap/m/MessageToast",
    "../model/formatter"
], function (BaseController, JSONModel, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, Fragment, MessageToast, formatter) {
    "use strict";

    return BaseController.extend("zc23matstock.controller.List", {
        ...
        onInit : function () {
            ...
            var oList = this.byId("list"),
                ...
                // /**
                //  * Search Field with Suggestion
                //  * https://sapui5.hana.ondemand.com/#/entity/sap.m.SearchField/sample/sap.m.sample.SearchFieldSuggestions/code/Page.controller.js
                //  */
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("Zmatnr", FilterOperator.Contains, sQuery)];
            } else {
		...
		// 		aFilters = [
		// 			new Filter([
		// 				new Filter("Zmatnr", function (sText) {
		// 					return (sText || "").toUpperCase().indexOf(sValue.toUpperCase()) > -1;
		// 				}),
		// 				new Filter("Zmatname", function (sDes) {
         ...
         */
         onSearch2: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("Zmatname", FilterOperator.Contains, sQuery)];
            } else {
                this._oListFilterState.aSearch = [];
            }
            this._applyFilterSearch();
         ...
         */
         onSearch3: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("Zmattype", FilterOperator.Contains, sQuery)];
            } else {
                this._oListFilterState.aSearch = [];
            }
            this._applyFilterSearch();
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "zc23matstock.view.ViewSettingsDialog",
                    controller: this
            ...
            if (!this.byId("viewSettingsDialog2")) {
                Fragment.load({
                    id: this.getView().getId(),
                    name: "zc23matstock.view.ViewSettingsDialog2",
                    controller: this
                }).then(function(oDialog){
                    // connect dialog to the root view of this component (models, lifecycle)
                    this.getView().addDependent(oDialog);
                ...
                this.byId("viewSettingsDialog2").open(sDialogTab);
            }
            if (!this.byId("viewSettingsDialog3")) {
                Fragment.load({
                    id: this.getView().getId(),
                    name: "zc23matstock.view.ViewSettingsDialog3",
                    controller: this
                }).then(function(oDialog){
                    // connect dialog to the root view of this component (models, lifecycle)
                    this.getView().addDependent(oDialog);
                ...
                this.byId("viewSettingsDialog3").open(sDialogTab);
            }
        },
        ...
        _showDetail: function (oItem) {
            ...
            this.getRouter().navTo("object", {
                objectId : oItem.getBindingContext().getProperty("Zmatnr")
            }, bReplace);
        },
